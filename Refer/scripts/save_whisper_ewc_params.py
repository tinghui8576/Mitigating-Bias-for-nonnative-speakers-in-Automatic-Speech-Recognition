...
from Refer.utils.initialize import initialize_env
# initialize_env()
...
from Refer.trainer.ewc_estimation import get_ewc_params_for_whisper
from Refer.utils.file_io import extract_exp_name_from_model_path
from Refer.utils.constants import CHECKPOINTS_DIR
...
# python Refer/scripts/save_whisper_ewc_params.py openai/whisper-small --language english --task transcribe --dataset-name CustomData/SSA --split train