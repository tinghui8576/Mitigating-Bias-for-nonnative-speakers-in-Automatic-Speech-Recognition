...
from datasets import DatasetDict, Audio, load_dataset, load_from_disk, concatenate_datasets
...
def load_all_datasets():
    datalist = [
        {"Name": "edinburghcstr/edacc", "Type": "load", "Split": "validation", "Column": "text"},
        ...
        {"Name": "CustomData/l2arctic/shards", "Type": "disk", "Split": "None", "Column": "transcript"},
        {"Name": "CustomData/commonvoice/shards", "Type": "disk", "Split": "None", "Column": "sentence"},
    ]
...
raw_dataset["train"] = load_all_datasets()
